+++
title = "[Grafana] 시작 및 소개 (with k8s)"
date = 2024-06-25T00:00:00+00:00
[taxonomies]
tags = ["Monitoring"]
[extra]
naver_log_no = 223491304838
naver_category_no = 381
+++

![](/images/img_00da6550d1493a7d.png)
...
![](/images/img_64232aab13694944.png)
이외에도 사용할 수 있는 외부 데이터소스는 매우 많다.  

<br>

![](/images/img_d145493fa4c045b8.png)

![](/images/img_1fd2dadf24a836d4.png)
...
![](/images/img_77f5811322413ee1.png)
그라파나는 다른 시스템들과의 연동도 풍부하게 지원하지만, 그 시스템들의 대체재들도 상당수 자체적으로 구현해서 지원한다.  

그 예로,  
1. Mimir는 자체적으로 만들어서 제공하는 메트릭 스토리지다. 그러니까, Prometheus를 대체할 수 있다.  
2. Loki는 로그 저장 및 검색 시스템이다. 로그를 저기다 쌓고 Grafana를 통해서 다룰 수 있다.  
3. Tempo는 전반적인 trace 모니터링 정보를 저장하는 시스템이다. 이 trace가 몇초동안 실행되었고, 오류를 얼마나 발생했고 그런걸 추적하는 용도다.  
4. pyroscope는 프로파일링 정보를 실시간으로 수집하는 용도의 시스템이다.  
...
![](/images/img_e9080a02ef209f65.png)
...
![](/images/img_361ed39a30413868.png)
...
![](/images/img_eb277d97fb9f8ee0.png)
...
![](/images/img_f98caff5927f03b2.png)
...
![](/images/img_d33e7010d70c9a20.png)

그리고 좀 기다리면 기본 리소스들이 생성된 것을 볼 수 있을 것이다.  

![](/images/img_0f4cdb81aeb25c82.png)
...
![](/images/img_3f01fdd594d545d1.png)
...
![](/images/img_361635691261c3f0.png)
그럼 이제 로그인을 해줘야 하는데  
...
![](/images/img_b5eb491a45e83097.png)
이러면 최초 생성 패스워드가 튀어나오고  

<br>

![](/images/img_76d41c7d5876a504.png)
admin으로 로그인하면  

<br>

![](/images/img_c5bbe6c85c26fc95.png)
들어가진다.  

<br>

![](/images/img_bf3b773a6535bc22.png)

![](/images/img_8b4b06915d1f49dc.png)
패스워드만 적당히 바꿔주고 둘러보자.  

<br>

![](/images/img_db36b48900b16739.png)
...
![](/images/img_2b98ca44a2027dbf.png)

![](/images/img_a9c49573296a5743.png)
그럼 뭐 이런 식으로 잔뜩 뭐가 있는데, 하나씩 봐보자.  

가장 중요한건 볼륨 설정이다.  

![](/images/img_d95f88a262412229.png)
기본 설정은 볼륨 설정이 꺼져있기 때문에, 이 Grafana 서버의 정보는 휘발성을 가진다.  
그러니까, 컨테이너 내려갔다 다시 올라가면 모든 설정이 초기화된다는 것이다.  

<br>

![](/images/img_99ff89b15221c438.png)
...
![](/images/img_d91a727e2af79474.png)
여기다 적당히 필요한 플러그인을 추가하면, 시작할때 플러그인을 설치하고 시작한다.  

<br>

![](/images/img_4ecfc89b3a6dc4df.png)
...
![](/images/img_7bd0934de1de90d2.png)
위에서는 kubectl patch를 통해 후처리로 로드밸런서를 열었었는데,  

<br>

![](/images/img_e5ed39bdfbf75149.png)
그냥 여기서 바꿔줘도 된다.  
...
![](/images/img_752bca152b041370.png)

![](/images/img_4c80905b8d5a187b.png)
좀 기다리면 된다.  
...
참조  
[https://grafana.com/docs/grafana/latest/setup-grafana/installation/helm/](https://grafana.com/docs/grafana/latest/setup-grafana/installation/helm/)  
[https://opensource.stackexchange.com/questions/5003/agplv3-source-redistribution-when-does-it-apply-to-my-code-for-a-server-side-ja/5004#5004](https://opensource.stackexchange.com/questions/5003/agplv3-source-redistribution-when-does-it-apply-to-my-code-for-a-server-side-ja/5004#5004)  
[https://stackoverflow.com/questions/67457018/why-do-i-keep-getting-error-5-pod-has-unbound-immediate-persistentvolumeclaims](https://stackoverflow.com/questions/67457018/why-do-i-keep-getting-error-5-pod-has-unbound-immediate-persistentvolumeclaims)
