...
```
이러면 이제 호스트의 /var/myapp-data 경로를 컨테이너 내의 /var/myapp-data에서도 접근할 수 있다는 뜻이 된다.  
...
![](/images/img_059c95960175c2df.png)
...
![](/images/img_1c4248430a1950a7.png)
...
1. 파일 서버를 먼저 구성한다. (보통 고가용성이 가능한 선택지를 고름. ceph, minio 등)  

2. k8s에서 파일서버를 Persistance Volume로서 사용할 수 있게 세팅한다.  

3. Pod를 만들때 Persistance Volume Claim를 붙여서 사용한다.  

4. 그러면 Persistance Volume Claim이 PV(파일서버)로부터 디스크 영역을 할당해와서 컨테이너에 연결한다.  
