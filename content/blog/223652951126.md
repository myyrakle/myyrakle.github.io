+++
title = "[Clickhouse] 저장 방식과 최적화 구조"
date = 2024-11-09T00:00:00+00:00
[taxonomies]
tags = ["Clickhouse"]
[extra]
naver_log_no = 223652951126
...
![](/images/img_6b97afe893a096a3.jpg)
...
![](/images/img_195a12a33f43a61b.png)
...
skipping index는 granule을 또 몇개를 묶어서 블럭-그룹으로 만들고 관리한다.  
"GRANULARITY N"에서 "GRANULARITY 4;"로 한다면 8192x4 크기가 하나의 skipping index 블럭이 되는 것이다.  

![](/images/img_56c462532904c886.jpg)
...
- **minmax**는 가장 단순한 구조의 skipping 인덱스다.  
...
- **bloom_filter**는 해시테이블의 변종인 블룸필터를 응용한 skip 구조다.  
오차가 있는 알고리즘이지만 "없다"고 판단한 것은 정확하기 때문에 매우 큰 데이터에 대해서 상당히 효율적으로 skip을 처리할 수 있다.  
원리에 대해서는 별도 포스트를 참조한다. [https://m.blog.naver.com/sssang97/223231946274](https://m.blog.naver.com/sssang97/223231946274)  
...
[https://clickhouse.com/docs/en/about-us/distinctive-features#true-column-oriented-dbms](https://clickhouse.com/docs/en/about-us/distinctive-features#true-column-oriented-dbms)  
[https://stackoverflow.com/questions/18831699/column-oriented-database-vs-row-oriented-database](https://stackoverflow.com/questions/18831699/column-oriented-database-vs-row-oriented-database)  
[https://ko.m.wikipedia.org/wiki/%EC%BB%AC%EB%9F%BC_%EC%A7%80%ED%96%A5_DBMS](https://ko.m.wikipedia.org/wiki/%EC%BB%AC%EB%9F%BC_%EC%A7%80%ED%96%A5_DBMS)  
[https://en.m.wikipedia.org/wiki/Data_orientation](https://en.m.wikipedia.org/wiki/Data_orientation)  
